...
app.Extracto_model = Backbone.Model.extend({
  ...
  url: function(){
    urlextracto = 'http://192.168.99.101:4060/day_extracts?d_0=' + this.get('d_0') + '&m_0=' + this.get('m_0') + '&a_0=' + this.get('a_0') + '&d_1=' + this.get('d_1') + '&m_1=' + this.get('m_1') + '&a_1=' + this.get('a_1');
